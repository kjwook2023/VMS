...
- Workflow name: Lunch-Menu-Alert
- Workflow ID: yoA71hDhAmCR2CmU
- Active: True
- Archived: False
- Created at: 2026-05-20T04:45:10.184Z
- Updated at: 2026-06-11T06:54:20.663Z
- Version counter: 15
- Node count: 9
...
- Lunch Schedule: 스케줄 필드: cronExpression

## 전체 흐름

- Lunch Schedule -> Weekday Baseline
- Weekday Baseline -> Holiday DB Fallback
- Holiday DB Fallback -> Determine Holiday
- Determine Holiday -> Not Holiday
- Not Holiday -> Fetch Kakao Lunch Posts
- Fetch Kakao Lunch Posts -> Select Lunch Post
- Select Lunch Post -> Build Teams Payload
...
- 해석 근거: type=n8n-nodes-base.httpRequest, url=https://pf.kakao.com/rocket-web/web/profiles/_xgUVZn/posts/recent?size=10
- Credential: 없음
...
- JSON payload: Lunch-Menu-Alert_api.json
- PowerShell upsert script: Lunch-Menu-Alert_api.ps1
