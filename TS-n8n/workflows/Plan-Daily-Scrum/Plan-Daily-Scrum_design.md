...
- Workflow name: Plan-Daily-Scrum
- Workflow ID: reXPlC1M4ftWESQO
- Active: True
- Archived: False
- Created at: 2026-03-03T05:42:08.935Z
- Updated at: 2026-05-21T23:22:13.871Z
- Version counter: 112
- Node count: 11
...
- 타입: n8n-nodes-base.code / version=2
- 역할: 사람이 읽을 수 있는 회의 또는 스프린트 안내 메시지를 만듭니다.
- 필요한 이유: 이 노드가 없으면 복잡한 업무 규칙을 기본 노드만으로 표현하기 어렵습니다.
- 해석 근거: type=n8n-nodes-base.code, meeting message logic detected
- Credential: 없음
...
- JSON payload: Plan-Daily-Scrum_api.json
- PowerShell upsert script: Plan-Daily-Scrum_api.ps1
